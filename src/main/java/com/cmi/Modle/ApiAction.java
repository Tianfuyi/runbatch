...
public class ApiAction {
    ...
    public  String login(String name,String pwd){
        ...
        String session =rc.login(address,"admin","66666666667D9836E1C960AE0ED2FE7C");
        return session;
    }
    ...
    public  String checkRunStatus(String session){
     ...
     //       String session = rc.login("54.223.53.238:7001", "admin", "4C590C75BD7D9836E1C960AE0ED2FE7C");
            String response = rc.requestByPost("http://"+address+"/cx/xxxxlist.do?EMP_SID=" + session ); //   信贷批次查询 Mag
    ...
    public  List<MagListBean>  magList(String session){
        RequestClient rc = new RequestClient();
        String response =rc.requestByPost("http://"+address+"/cx/xxxxlist.do?EMP_SID="+session);
    ...
    ApiAction ac = new ApiAction("127.0.0.1:8001");
